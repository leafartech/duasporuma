            ...
            <header className="w-full sm:min-h-screen flex justify-center items-center" id="forms">
                <div className="w-full max-w-7xl flex flex-col sm:grid sm:grid-cols-2 sm:items-center sm:gap-12 px-4 sm:px-0">
                    <div className="flex flex-col gap-4 pt-6 sm:pt-0">
                        ...
                        <h1 className="title">Aprenda o método dos Brasileiros na Europa para Economizar 50% nas passagens aéreas para o Brasil.</h1>
                    ...
                    <div className="w-full flex flex-col gap-6 sm:gap-12">
                        ...
                        >
                            <div className="text-zinc-600 font-medium text-sm sm:text-lg">
                                <p>Aumentos de preços por todos os lados. Isso não é diferente no mundo das passagens aéreas.</p>
                                <p>O preço alto das passagens impossibilitam nossas famílias de se relacionar com os avós, familiares e amigos, assim como de passarmos datas importantes no Brasil, nos fazendo perder o recurso mais importante que temos: o tempo.</p>
                            </div>
                        </HeroFlex>
                        <HeroFlex
                        ...
                        >
                            <div className="text-zinc-600 font-medium sm:text-lg">
                                <p>Chegou a hora de você aprender emitir passagens com 50% de desconto e nunca mais perder uma data importante no Brasil por causa dos preços das passagens.</p>
                                <p>O treinamento Duas Por Uma é o movimento que levará o maior número de brasileiros morando no exterior para passar datas importantes no Brasil em 2023. Vai deixar sua família de fora?</p>
                            </div>
                        </HeroFlex>
                    </div>
                </Section>  
