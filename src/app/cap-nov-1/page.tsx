            ...
            <header className="w-full sm:min-h-screen flex justify-center items-center">
                <div className="w-full max-w-7xl flex flex-col sm:grid sm:grid-cols-2 sm:items-center sm:gap-12 px-4 sm:px-0">
                    ...
                    <div className="mb-6 mt-2 sm:mt-0 sm:mb-0 sm:flex sm:justify-end">
                        <img src="./images/nov/bg.webp" alt="Foto da Ani levando filho para conhecer os avós no Brasil" className="w-full sm:max-w-[456px]" />
                    </div>
                </div>
            </header>
            <main>
